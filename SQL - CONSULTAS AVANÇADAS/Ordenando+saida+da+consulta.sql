...
SELECT DISTINCT * FROM [TABELA DE PRODUTOS] WHERE [NOME DO PRODUTO] = 'Linha Refrescante - 1 Litro - Morango/Limão'

SELECT TOP 1 [CODIGO DO PRODUTO],QUANTIDADE FROM [ITENS NOTAS FISCAIS] WHERE [CODIGO DO PRODUTO] = '1101035'
